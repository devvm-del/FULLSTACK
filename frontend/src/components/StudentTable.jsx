...
import useAcceptedStudent from "../hooks/admin/useAcceptedStudent";
import useSearchPagination from "../hooks/admin/useSearchPagination";
import useToggleUserStatus from "../hooks/admin/useToggleStatus";

function AcceptedStudent() {
  const { theme } = useTheme();
  const isDark = theme === "dark";

  const { users, loading, error } = useAcceptedStudent();
                ...
                <td className="text-center align-middle">
                  <div className="d-flex justify-content-center gap-2">
                    ...
                    >
                      <i
                        className={`bi ${
                          user.is_enabled ? "bi-toggle2-off" : "bi-toggle2-on"
                        }`}
                      ></i>
